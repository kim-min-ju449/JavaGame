...
public class Game extends Thread {
    ...
    private ArrayList<Enemy2> enemyList2 = new ArrayList<Enemy2>();
    private ArrayList<EnemyAttack> enemyAttackList = new ArrayList<EnemyAttack>();
    private ArrayList<EnemyAttack2> enemyAttackList2 = new ArrayList<EnemyAttack2>();
    ...
    private void enemyAppearProcess() {
        if (cnt % 80 == 0) {
            enemy = new Enemy(1120, (int)(Math.random()*621)); //1120Àº  xÁÂÇ¥ 621Àº yÁÂÇ¥ //ÀÌ°É 1 ÇÏ´Ï À§¸¸ ³ª¿È
            enemyList.add(enemy);
        }
        if (cnt % 80 == 0) {
            enemy2 = new Enemy2(1120, (int)(Math.random()*621)); //1120Àº  xÁÂÇ¥ 621Àº yÁÂÇ¥ //ÀÌ°É 1 ÇÏ´Ï À§¸¸ ³ª¿È
    ...
    private void enemyAttackProcess() {
        if (cnt % 50 == 0) {
           enemyAttack = new EnemyAttack(enemy.x - 79, enemy.y + 35);
        	//enemyAttack = new EnemyAttack(enemy.x - 39, enemy.y + 15);
    ...
    public void infoDraw(Graphics g) {
        ...
        if (isOver) {
            ...
            g.drawString("restart R", 295, 380);
        }
    }
